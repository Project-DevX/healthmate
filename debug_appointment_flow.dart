...
void main() async {
  ...
  try {
    ...
    print('📋 Found ${existingAppointments.docs.length} existing appointments:');
    ...
    final appointmentId = await InterconnectService.bookAppointment(testAppointment);
    ...
    print('📋 Found ${updatedAppointments.docs.length} appointments after booking:');
    ...
    print('📋 InterconnectService returned ${serviceAppointments.length} appointments:');
